...
export default function Upsell2Page() {
  ...
  // REMOVIDO: useEffect da Hotmart
  // ADICIONADO: Script da Mundpay no return
          ...
          {pageState === 'results' && (
            <div className="space-y-4 animate-fade-in">
              ...
              <div className="bg-white p-5 rounded-lg shadow-xl text-center">
                ...
                {/* DIV DA MUNDPAY ADICIONADA AQUI */}
                <div className="w-full pt-4" data-mndpay-render="019aea40-52c3-7269-8665-af181aa4658b"></div>
